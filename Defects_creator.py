...
Choice = input('Please enter the type of analysis, you would like to perform:','\n','if you want to finish enter stop','\n' ,'if you want to get defects on one step print 1','\n',' if you want to get defects in muliple steps print 2 ')
Choice.lower()
